...
DFEvaluation_Data <- read.csv(file.choose())
DFEvaluation_Data

#Load Life expectancy data for years 1960 and 2013
...
#Data Frame creation
CountriesAndRegion <- data.frame(Country= Countries_2012_Dataset, Code= Codes_2012_Dataset, Region= Regions_2012_Dataset)
CountriesAndRegion
head(CountriesAndRegion)

Life.expectancy <- c(Life_Expectancy_At_Birth_1960,Life_Expectancy_At_Birth_2013)
Life.expectancy

dataframe_Life <- data.frame(DataFrameEvaluation_Data, Life.expectancy= Life.expectancy)
dataframe_Life

merge.dataframe_life.CountriesAndRegion <- merge(dataframe_Life, CountriesAndRegion, by.x = "Country.Code", by.y = "Code")
head(merge.dataframe_life.CountriesAndRegion)

#Graphics
library(ggplot2)
qplot(data=merge.dataframe_life.CountriesAndRegion, x=Fertility.Rate, y=Life.expectancy)
